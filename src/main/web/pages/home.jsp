    ...
    <div class="row">
        <div class="col-xs-8 col-xs-offset-2">
            <h3 class="page-header">
                ...
                <div class="btn-group pull-right">
                    <button type="button" class="btn btn-success" id="find" onclick="jump()">Find</button>
                </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#upload').click(function() {
            if ($('#image_name').val() == '' || $('#image').val() == '') {
                ...
                $('#form').attr('action', '${pageContext.request.contextPath}' + '/image.action?type=1');
        ...
        //点击确定退出
        $('#exit').click(function() {
            $.get('${pageContext.request.contextPath}' + '/user.action?type=3', function(data, status) {
        ...
        $('#delete').click(function() {
            ...
            $.post('${pageContext.request.contextPath}' + '/image.action?type=2', {
                ids: ids,
                urls: urls
    ...
    //跳转至图片广场
    function jump() {
        window.location.href = '${pageContext.request.contextPath}' + '/image.action?type=3'
    }
